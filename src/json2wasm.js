...
const OPCODES = (json2wasm.OPCODES = {
	...
	"trunc_memory.init": [0xfc, 0x8],
	"trunc_data.drop": [0xfc, 0x9],
	"trunc_memory.copy": [0xfc, 0xa],
	"trunc_memory.fill": [0xfc, 0xb],
	"trunc_table.init": [0xfc, 0xc],
	"trunc_elem.drop": [0xfc, 0xd],
	"trunc_table.copy": [0xfc, 0xe],
	"trunc_table.grow": [0xfc, 0xf],
	"trunc_table.size": [0xfc, 0x10],
	"trunc_table.fill": [0xfc, 0x11],
});
